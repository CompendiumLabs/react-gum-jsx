...
const primitiveNames = [
  'Element', 'Group', 'Svg', 'Box', 'Frame', 'Stack', 'HWrap', 'VStack', 'HStack', 'Grid', 'Points', 'Anchor', 'Attach', 'Absolute', 'Spacer', 'Ray', 'Line', 'UnitLine', 'HLine', 'VLine', 'Rectangle', 'RoundedRect', 'Square', 'Ellipse', 'Circle', 'Dot', 'Shape', 'Path', 'Command', 'MoveCmd', 'LineCmd', 'ArcCmd', 'CornerCmd', 'CubicSplineCmd', 'Spline', 'Triangle', 'Arrow', 'Field', 'Span', 'Text', 'TextBox', 'TextFrame', 'TextStack', 'TextFlex', 'Bold', 'Italic', 'Latex', 'Equation', 'TitleBox', 'TitleFrame', 'ArrowHead', 'ArrowSpline', 'Node', 'Edge', 'Network', 'SymPoints', 'SymLine', 'SymSpline', 'SymShape', 'SymFill', 'SymField', 'Bar', 'VBar', 'HBar', 'Bars', 'VBars', 'HBars', 'Scale', 'VScale', 'HScale', 'Labels', 'VLabels', 'HLabels', 'Axis', 'HAxis', 'VAxis', 'BoxLabel', 'Mesh', 'HMesh', 'VMesh', 'Mesh2D', 'Graph', 'Plot', 'BarPlot', 'Legend', 'Slide',
] as const
...
export const {
  Element, Group, Svg, Box, Frame, Stack, VStack, HStack, HWrap, Grid, Points, Anchor, Attach, Absolute, Spacer, Ray, Line, UnitLine, HLine, VLine, Rectangle, RoundedRect, Square, Ellipse, Circle, Dot, Shape, Path, Command, MoveCmd, LineCmd, ArcCmd, CornerCmd, CubicSplineCmd, Spline, Triangle, Arrow, Field, Span, Text, TextBox, TextFrame, TextStack, TextFlex, Bold, Italic, Latex, Equation, TitleBox, TitleFrame, ArrowHead, ArrowSpline, Node, Edge, Network, SymPoints, SymLine, SymSpline, SymShape, SymFill, SymField, Bar, VBar, HBar, Bars, VBars, HBars, Scale, VScale, HScale, Labels, VLabels, HLabels, Axis, HAxis, VAxis, BoxLabel, Mesh, HMesh, VMesh, Mesh2D, Graph, Plot, BarPlot, Legend, Slide
} = CONTEXT
